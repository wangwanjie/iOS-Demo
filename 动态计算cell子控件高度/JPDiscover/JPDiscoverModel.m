...
+ (JPDiscoverContentModel *)getTestModel {
    ...
    testModel.content = @"这个是一个类似朋友圈、发现页等Feed的样式效果 + 网易新闻的侧滑效果（暂未更新上来），实现方式是我自己设计的，之前很多人群里问过我类似的效果怎么实现，每次我都是光用嘴说给大家听，想想这次项目中正好用到这个需求，于是便自己做了一个，之后从项目中重构出来一份Demo给大家，精力有限，其他功能陆续更新上来，也会陆续完善注释、框架图等等，大家看个乐呵就好，互相交流交流思路，写的不好请轻喷，如果有写错的地方，请issue~谢谢！";
    return testModel;
}
