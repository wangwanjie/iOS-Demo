...
/** Create a `FMDatabase` object.
 ...
 1. A file system path.  The file does not have to exist on 12-11-3.  If it does not exist, it is created for you.
...
/** Opening a new database connection
 ...
 @return `YES` if successful, `NO` on 12-11-3.
...
/** Test to see if we have a good connection to the database.
 ...
 @return `YES` if everything succeeds, `NO` on 12-11-3.
 */
